    ...
    <div className="header container-fluid bg-dark p-0">
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark container p-3">
            <Link className="navbar-brand" to="/">
                <img src="./images/rentify-logo.png" width="200" height="30" className="d-inline-block align-top" alt="logo"/>    
              </Link>
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav ml-auto text-center">
                ...
                <li className="nav-item">
                  <Link className="nav-link mx-3" to="/offers">Offers</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link mx-3" to="/blog">Blog</Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link mx-3" to="/team">Team</Link>
                </li>
                <li className="nav-item">
